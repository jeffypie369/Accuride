...
public class Dijkstra {
    ...
    public static void leastTransfersHelper(ArrayList<ArrayList<Edge>> adjList, HashMap<Integer, String> hmap2, ArrayList<Integer> possibleStarts, ArrayList<Integer> possibleEnds) {
